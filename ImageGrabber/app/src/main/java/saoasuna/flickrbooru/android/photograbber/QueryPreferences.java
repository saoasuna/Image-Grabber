...
// for storing the most recently queried search
public class QueryPreferences {
    private static final String PREF_SEARCH_QUERY = "searchQuery"; // key for the query preference
    private static final String PREF_LAST_RESULT_ID = "lastResultId"; // last searched result so that we can poll for updates
